...
/***/ "./src/blocks/modules/industry-specialization/industry-specialization.js":
/*!*******************************************************************************!*\
  !*** ./src/blocks/modules/industry-specialization/industry-specialization.js ***!
  \*******************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return IndustrySpecialization; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
var IndustrySpecialization = /*#__PURE__*/function () {
  ...
  _createClass(IndustrySpecialization, [{
    ...
    value: function initSliders() {
      var $nav = $(".industry-specialization-slider-nav");
      var $navSlider = $nav.find('.industry-specialization-slider-nav__list');
...
var mainAbout = /*#__PURE__*/function () {
  ...
  _createClass(MainAbout, [{
    ...
    value: function animateCircle() {
      ...
      var self = this;
      if (window.innerWidth > 1023) {
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__circle', {
          scrollTrigger: {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__title', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top-=500',
            end: 'top',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__description', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top-=500',
            end: 'top',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__statistics-item--1', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top-=100',
            end: 'top+=100',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__statistics-item--2', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top',
            end: 'top+=200',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__statistics-item--3', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top+=100',
            end: 'top+=300',
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["gsap"].to('.main-about__statistics-item--4', {
          scrollTrigger: {
            trigger: '.trigger-wrapper-about',
            start: 'top+=200',
            end: 'top+=400',
...
/* harmony import */ var _modules_industry_specialization_industry_specialization__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! %modules%/industry-specialization/industry-specialization */ "./src/blocks/modules/industry-specialization/industry-specialization.js");
...
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! slick-carousel */ "./node_modules/slick-carousel/slick/slick.js");
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_29__);
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! gsap/ScrollTrigger */ "./node_modules/gsap/ScrollTrigger.js");
...
jquery__WEBPACK_IMPORTED_MODULE_28___default()(function () {
  setTimeout(function () {
    window.addEventListener("scroll", function (event) {
      var top = this.pageYOffset;
      var layers = jquery__WEBPACK_IMPORTED_MODULE_28___default()(".parallax__layer");
      var speed, yPos;
      layers.each(function () {
        speed = jquery__WEBPACK_IMPORTED_MODULE_28___default()(this).attr('data-speed');
        var yPos = -(top * speed / (window.innerWidth / 20));
        jquery__WEBPACK_IMPORTED_MODULE_28___default()(this).attr('style', 'transform: translate3d(0px, ' + yPos + 'px, 0px)');
      });
    });
  }, 1000);
  jquery__WEBPACK_IMPORTED_MODULE_28___default()('.case_ss__sl').slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    arrows: false,
    dots: true,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_28___default()('a[href^="#"').on('click', function (e) {
    e.preventDefault;
    if (!jquery__WEBPACK_IMPORTED_MODULE_28___default()(this).attr('data-tab-id')) {
      var href = jquery__WEBPACK_IMPORTED_MODULE_28___default()(this).attr('href');
      if (href != '#') {
        jquery__WEBPACK_IMPORTED_MODULE_28___default()('html, body').animate({
          scrollTop: jquery__WEBPACK_IMPORTED_MODULE_28___default()(href).offset().top
        });
      }
      return false;
    }
...
gsap__WEBPACK_IMPORTED_MODULE_30__["default"].registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_31__["ScrollTrigger"]);
window.app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  data: function data() {
    return {
      ...
      isSafary: false,
      industrySpecialization: new _modules_industry_specialization_industry_specialization__WEBPACK_IMPORTED_MODULE_27__["default"]()
    };
  },
  mounted: function mounted() {
    ...
    setTimeout(function () {
      ...
      _this.industrySpecialization.init();
    ...
    if (document.querySelector('.career-first-title').offsetWidth > window.innerWidth) {
      ...
      document.addEventListener('mousemove', function (event) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_30__["default"].to('.career-first-title', {
  ...
  methods: {
    buttonMouseEnter: function buttonMouseEnter(event) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_30__["default"].to(event.target.children[1], 0.5, {
        width: 800,
        height: 800,
        x: -400,
        y: -400
    ...
    buttonMouseLeave: function buttonMouseLeave(event) {
      ...
      event.target.children[1].style.left = x + 'px';
      event.target.children[1].style.top = y + 'px';
      gsap__WEBPACK_IMPORTED_MODULE_30__["default"].to(event.target.children[1], 0.3, {
        width: 0,
        height: 0,
        x: 0,
        y: 0,
    ...
    animateTitles: function animateTitles() {
      if (document.querySelectorAll(".animated-title")) {
        document.querySelectorAll(".animated-title").forEach(function (item, i) {
          gsap__WEBPACK_IMPORTED_MODULE_30__["default"].to(item, {
            scrollTrigger: {
              trigger: item,
              start: 'top bottom',
              ...
              onUpdate: function onUpdate(item) {
                if (item.progress > 0.1) {
                  gsap__WEBPACK_IMPORTED_MODULE_30__["default"].to(item.trigger, 2.5, {
